/*Name: Jiazi Cai jiazi@bu.edu
 * This is the fish and shark animation, user can use keys to add food
 * to the tank and fish can eat the food. But shark will only look for
 * fish and eat it. When shark eats the fish, the fish will die and
 * turn white and going up to the top of the tank. User can summon 
 * new fish by pressing key S, add food by pressing F.
 * 
 *Based on the code of Lab7 about the construction of the fish and 
 *implement potential functions when calculate the distance and 
 *Collision of the walls to avoid going outside of this tank.
 *Also used the helper function of the SolidCylinder.java to create
 *surface of the two creatures. Also use the bounding boxes and sphere 
 *in detecting if the two are reacting to each other and based on 
 *that condition to set up dead, or food is eaten conditions.
 *
*/
import javax.swing.*;
...
private GLUT glut;
  ...
  public PA3()
  {
    ...
    setTitle("CS480/CS680 : Fish and Shark");
